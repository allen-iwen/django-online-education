...
class Stage(models.Model):
    ...
    course = models.ForeignKey(Course,related_name='stages',on_delete=models.CASCADE,verbose_name='课程分类',null=True,blank=True)
...
class Chapter(models.Model):
    ...
    stage = models.ForeignKey(Stage,related_name='chapters',on_delete=models.CASCADE,verbose_name='课程阶段',null=True,blank=True)
...
class Section(models.Model):
    ...
    chapter = models.ForeignKey(Chapter,related_name='sections',on_delete=models.CASCADE,verbose_name='课程章节',null=True,blank=True)
